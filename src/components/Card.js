...
export default function Card ({card, onCardClick, onCardDelete, onCardLike, onCardDislike}) {
  ...
  const cardLikeButtonClassName = ( 
    `element__like ${isLiked && 'element__like_aktive'}` 
  );
  ...
  return (
    <li className="element">
        <img src={card.link} alt={card.name} className="element__foto" onClick={handleClick}/>
        ...
        {/* onClick={() =>{ handleCardLike(); handleCardDislike()}} */}
